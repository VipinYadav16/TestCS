        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="inline-flex items-center bg-primary/10 rounded-full px-4 py-1.5 mb-6 border border-primary/20 animate-fade-in">
            ...
            <span className="text-xs font-medium text-primary">
              AI-Powered Crypto Market Manipulation
            </span>
          </div>
          ...
          >
            <span className="inline-block">AI-Driven Security for a Safer</span>{" "}
            <span className="inline-block text-gradient">Web3</span>{" "}
          ...
          >
            Our approach detects suspicious on crypto price manipulation,
            helping you invest safely.
          </p>
          ...
          {/* Stats */}
          <div
            className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto animate-fade-in"
            style={{ animationDelay: "400ms" }}
          >
            {[
              { label: "Potential Manipulation Detected", value: "1,000+" },
              { label: "Customer Satisfaction", value: "Good" },
              { label: "Average Detection Time", value: "<2s" },
            ].map((stat, index) => (
